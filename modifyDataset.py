...
def load_and_process_extractions(extraction_dir: str = "extracted_content") -> Dict[str, List[Dict]]:
    """
    ...
    for json_file in json_files:
        ...
        question_id = data.get('question_id', f"{category}-{index}")
...
def modify_dataset_with_extractions():
    ...
    output_path = "bright_modified_with_extractions"
